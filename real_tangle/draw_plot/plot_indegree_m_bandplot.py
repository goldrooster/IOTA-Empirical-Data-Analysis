...
with open('ALL_tangle_m_in_degree_list.json') as f:
...
plt.yticks([1, 10,100, 1000,10000,100000], fontsize=6)

plt.tight_layout()
plt.legend(fontsize=5,ncol = 2)
plt.savefig('D:/Users/f80055129/Desktop/Submission_Fig/eps_13/ALL_tangle_m_indegree_max_min_band.pdf',bbox_inches='tight', pad_inches=0)
plt.savefig('D:/Users/f80055129/Desktop/Submission_Fig/eps_13/ALL_tangle_m_indegree_max_min_band.png', bbox_inches='tight', pad_inches=0)
# plt.show()