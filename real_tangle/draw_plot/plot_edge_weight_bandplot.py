...
with open('ALL_tangle_ew_list.json') as f:
    data0 = json.load(f)
with open('Sim_all_edge_weight.json') as f:
    data1 = json.load(f)
data0 = data0[0:31]
mean_list = []
median_list = []
...
plt.savefig('D:/Users/f80055129/Desktop/Submission_Fig/eps_13/ALL_tangle_edge_weight_max_min_band.pdf',bbox_inches='tight', pad_inches=0)
plt.savefig('D:/Users/f80055129/Desktop/Submission_Fig/eps_13/ALL_tangle_edge_weight_max_min_band.png', bbox_inches='tight', pad_inches=0)
# plt.show()